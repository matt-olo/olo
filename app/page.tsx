    ...
    <section id="apply" className="relative py-28 px-6">
      <Reveal>
        <div className="mx-auto max-w-[640px]">
          ...
          <h2 className="mb-4 text-center text-[36px] font-bold tracking-tight text-white sm:text-[44px] relative">
            <span className="invisible">Ready to delete your overhead?</span>
