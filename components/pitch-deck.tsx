      ...
      <div className="relative flex h-full flex-col justify-between px-[120px] py-[80px]">
        ...
        <div className="flex-1 flex flex-col justify-center rounded-2xl border border-[#2dd4bf]/10 bg-[#2dd4bf]/[0.08] px-10 py-8 mt-4">
          ...
          <div className="flex gap-8 mb-10">
            <div className="flex-1 rounded-2xl border-2 border-[#0ea5e9]/30 px-10 py-10" style={{ background: 'linear-gradient(135deg, rgba(14,165,233,0.08) 0%, rgba(6,182,212,0.04) 100%)', boxShadow: '0 8px 32px rgba(14,165,233,0.12), 0 0 20px rgba(6,182,212,0.06)' }}>
              <p className="text-[58px] font-black text-[#0ea5e9] mb-3">36%</p>
              <p className="text-[20px] text-white/70 leading-[1.6]">of entrepreneurs&apos; workweek spent on non-revenue admin work</p>
            </div>
            <div className="flex-1 rounded-2xl border-2 border-red-500/30 px-10 py-10" style={{ background: 'linear-gradient(135deg, rgba(239,68,68,0.08) 0%, rgba(185,28,28,0.04) 100%)', boxShadow: '0 8px 32px rgba(239,68,68,0.12), 0 0 20px rgba(239,68,68,0.06)' }}>
              <p className="text-[58px] font-black text-red-400 mb-3">1 in 3</p>
