  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden font-[var(--font-montserrat)]">
      ...
      <div className="relative flex h-full flex-col justify-between px-[120px] py-[80px]">
        ...
        {/* Main content area */}
        <div className="flex-1 flex flex-col justify-center rounded-2xl border border-[#2dd4bf]/10 bg-[#0a2020]/[0.45] backdrop-blur-[2px] px-10 py-8 mt-4">
          {/* Main title */}
    ...
    <div className="relative flex h-full w-full flex-col overflow-hidden font-[var(--font-montserrat)]">
      ...
      <div className="relative flex h-full px-[120px] py-[70px]">
        ...
        <div className="flex w-[55%] flex-col justify-between pr-10">
          ...
          {/* Main content */}
          <div className="flex-1 flex flex-col justify-center rounded-2xl border border-[#2dd4bf]/10 bg-[#0a2020]/[0.45] backdrop-blur-[2px] px-10 py-8">
            {/* Big title */}
  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden font-[var(--font-montserrat)]">
      ...
      <div className="relative flex h-full flex-col justify-between px-[120px] py-[70px]">
        ...
        {/* Main */}
        <div className="flex-1 flex flex-col justify-center rounded-2xl border border-[#2dd4bf]/10 bg-[#0a2020]/[0.45] backdrop-blur-[2px] px-10 py-6">
          {/* Title */}
          <h1 className="mb-4 text-[48px] font-bold leading-tight text-white">
    ...
    <div className="relative flex h-full w-full flex-col overflow-hidden font-[var(--font-montserrat)]">
      ...
      <div className="relative flex h-full px-[80px] py-[35px]">
        ...
        <div className="flex w-[58%] flex-col justify-center pr-10">
          ...
          <div className="rounded-2xl border border-[#2dd4bf]/10 bg-[#0a2020]/[0.45] backdrop-blur-[2px] px-10 py-8">
