        ...
        <div className="flex-1 flex flex-col justify-center rounded-2xl border border-[#2dd4bf]/10 bg-[#2dd4bf]/[0.08] px-10 py-8">
          ...
          <div className="mt-8 relative w-full flex justify-center">
            <svg width="100%" height="320" viewBox="-110 -30 1240 340" fill="none" preserveAspectRatio="xMidYMid meet">
              ...
              {/* Numbered circles */}
              <circle cx="-50" cy="200" r="36" fill="#0a1e1e" stroke="#0ea5e9" strokeWidth="3" style={{ filter: 'drop-shadow(0 0 12px rgba(14,165,233,0.5))' }} />
              <text x="-50" y="210" textAnchor="middle" fill="#0ea5e9" fontSize="28" fontWeight="bold">1</text>
              <circle cx="165" cy="55" r="36" fill="#0a1e1e" stroke="#2dd4bf" strokeWidth="3" style={{ filter: 'drop-shadow(0 0 12px rgba(45,212,191,0.5))' }} />
              <text x="165" y="65" textAnchor="middle" fill="#2dd4bf" fontSize="28" fontWeight="bold">2</text>
              <circle cx="505" cy="55" r="36" fill="#0a1e1e" stroke="#06b6d4" strokeWidth="3" style={{ filter: 'drop-shadow(0 0 12px rgba(6,182,212,0.5))' }} />
              <text x="505" y="65" textAnchor="middle" fill="#06b6d4" fontSize="28" fontWeight="bold">3</text>
              <circle cx="845" cy="55" r="36" fill="#0a1e1e" stroke="#34d399" strokeWidth="3" style={{ filter: 'drop-shadow(0 0 12px rgba(52,211,153,0.5))' }} />
              <text x="845" y="65" textAnchor="middle" fill="#34d399" fontSize="28" fontWeight="bold">4</text>
              <circle cx="1050" cy="200" r="36" fill="#0a1e1e" stroke="#0d9488" strokeWidth="3" style={{ filter: 'drop-shadow(0 0 12px rgba(13,148,136,0.5))' }} />
              <text x="1050" y="210" textAnchor="middle" fill="#0d9488" fontSize="28" fontWeight="bold">5</text>
            </svg>
          </div>
