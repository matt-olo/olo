      ...
      <div className="relative flex h-full flex-col justify-between px-[120px] py-[80px]">
        ...
        <div className="flex-1 flex flex-col justify-center rounded-2xl border border-[#2dd4bf]/10 bg-[#2dd4bf]/[0.08] px-10 py-8">
          ...
          <div className="mt-8 relative w-full flex justify-center">
            <svg width="800" height="220" viewBox="0 0 800 220" fill="none">
              {/* Road body */}
              <path d="M 0 130 H 100 V 40 C 100 20 120 20 120 20 H 160 C 180 20 180 40 180 40 V 180 C 180 200 200 200 200 200 H 280 C 300 200 300 180 300 180 V 40 C 300 20 320 20 320 20 H 360 C 380 20 380 40 380 40 V 180 C 380 200 400 200 400 200 H 480 C 500 200 500 180 500 180 V 40 C 500 20 520 20 520 20 H 560 C 580 20 580 40 580 40 V 130 H 800" stroke="rgba(45,212,191,0.18)" strokeWidth="38" strokeLinecap="round" strokeLinejoin="round" />
              {/* Center dashed */}
              <path d="M 0 130 H 100 V 40 C 100 20 120 20 120 20 H 160 C 180 20 180 40 180 40 V 180 C 180 200 200 200 200 200 H 280 C 300 200 300 180 300 180 V 40 C 300 20 320 20 320 20 H 360 C 380 20 380 40 380 40 V 180 C 380 200 400 200 400 200 H 480 C 500 200 500 180 500 180 V 40 C 500 20 520 20 520 20 H 560 C 580 20 580 40 580 40 V 130 H 800" stroke="rgba(45,212,191,0.35)" strokeWidth="2" strokeDasharray="10 7" fill="none" />
            </svg>
          </div>
