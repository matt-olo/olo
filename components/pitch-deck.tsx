        ...
        <div className="flex-1 flex flex-col justify-center rounded-2xl border border-[#2dd4bf]/10 bg-[#2dd4bf]/[0.08] px-10 py-8">
          ...
          <div className="mt-8 relative w-full flex justify-center">
            <svg width="100%" height="320" viewBox="-110 -30 1240 340" fill="none" preserveAspectRatio="xMidYMid meet">
              ...
              <text x="-50" y="280" textAnchor="middle" fill="#0ea5e9" fontSize="16" fontWeight="600" style={{ filter: 'drop-shadow(0 0 6px rgba(14,165,233,0.4))' }}>Task</text>
              ...
              <text x="165" y="135" textAnchor="middle" fill="#2dd4bf" fontSize="16" fontWeight="600" style={{ filter: 'drop-shadow(0 0 6px rgba(45,212,191,0.4))' }}>olo</text>
              ...
              <text x="505" y="135" textAnchor="middle" fill="#06b6d4" fontSize="16" fontWeight="600" style={{ filter: 'drop-shadow(0 0 6px rgba(6,182,212,0.4))' }}>Tool</text>
              ...
              <text x="845" y="135" textAnchor="middle" fill="#34d399" fontSize="16" fontWeight="600" style={{ filter: 'drop-shadow(0 0 6px rgba(52,211,153,0.4))' }}>Validate</text>
              ...
              <text x="1050" y="275" textAnchor="middle" fill="#0d9488" fontSize="16" fontWeight="600" style={{ filter: 'drop-shadow(0 0 6px rgba(13,148,136,0.4))' }}>Your</text>
              <text x="1050" y="293" textAnchor="middle" fill="#0d9488" fontSize="16" fontWeight="600" style={{ filter: 'drop-shadow(0 0 6px rgba(13,148,136,0.4))' }}>Approval</text>
            </svg>
          </div>
