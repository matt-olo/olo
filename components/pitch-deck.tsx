      ...
      <div className="relative flex h-full px-[120px] py-[70px]">
        ...
        <div className="flex w-[55%] flex-col justify-between pr-10">
          ...
          <div className="flex-1 flex flex-col justify-center rounded-2xl border border-[#2dd4bf]/10 bg-[#2dd4bf]/[0.08] px-10 py-8">
            ...
            <h1 className="mb-14 text-[72px] font-black leading-none tracking-tight">
              ...
              <span style={{ background: 'linear-gradient(to right, #fca5a5, #ef4444, #dc2626)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', display: 'inline' }}>SMB automation does not.</span>
            </h1>
        ...
        <div className="relative flex w-[45%] items-center justify-center">
          ...
          <div className="absolute inset-0 z-10 pointer-events-none flex items-center justify-center">
            <span className="font-black leading-none select-none" style={{ color: 'rgba(239, 68, 68, 0.35)', fontSize: '500px' }}>✕</span>
          </div>
