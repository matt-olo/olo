      ...
      <div className="relative flex h-full flex-col justify-between px-[120px] py-[80px]">
        ...
        <div className="flex-1 flex flex-col justify-center rounded-2xl border border-[#2dd4bf]/10 bg-[#2dd4bf]/[0.08] px-10 py-8 mt-4">
          ...
          <div className="flex gap-8 mb-10">
            <div className="flex-1 rounded-2xl border-2 border-[#0ea5e9]/30 px-10 py-10" style={{ background: 'linear-gradient(145deg, rgba(14,165,233,0.06) 0%, rgba(6,182,212,0.02) 100%)', boxShadow: '0 4px 24px rgba(14,165,233,0.1)' }}>
            ...
            <div className="flex-1 rounded-2xl border-2 border-red-500/30 px-10 py-10" style={{ background: 'linear-gradient(145deg, rgba(239,68,68,0.06) 0%, rgba(185,28,28,0.02) 100%)', boxShadow: '0 4px 24px rgba(239,68,68,0.1)' }}>
